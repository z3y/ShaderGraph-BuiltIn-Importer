Shader "Imported Shader Graphs/Standard"
{
    Properties
    {
        ...
        [Toggle(FORCE_SPECCUBE_BOX_PROJECTION)]FORCE_SPECCUBE_BOX_PROJECTION("Force Box Projection", Float) = 0
...
#pragma shader_feature_local_fragment _BICUBICLIGHTMAP
        ...
        #pragma shader_feature_local _ FORCE_SPECCUBE_BOX_PROJECTION
        
        #if defined(_GSAA) && defined(_BUMPMAP) && defined(_MASKMAP) && defined(_EMISSION) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_0
        #elif defined(_GSAA) && defined(_BUMPMAP) && defined(_MASKMAP) && defined(_EMISSION)
            #define KEYWORD_PERMUTATION_1
        #elif defined(_GSAA) && defined(_BUMPMAP) && defined(_MASKMAP) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_2
        #elif defined(_GSAA) && defined(_BUMPMAP) && defined(_MASKMAP)
            #define KEYWORD_PERMUTATION_3
        #elif defined(_GSAA) && defined(_BUMPMAP) && defined(_EMISSION) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_4
        #elif defined(_GSAA) && defined(_BUMPMAP) && defined(_EMISSION)
            #define KEYWORD_PERMUTATION_5
        #elif defined(_GSAA) && defined(_BUMPMAP) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_6
        #elif defined(_GSAA) && defined(_BUMPMAP)
            #define KEYWORD_PERMUTATION_7
        #elif defined(_GSAA) && defined(_MASKMAP) && defined(_EMISSION) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_8
        #elif defined(_GSAA) && defined(_MASKMAP) && defined(_EMISSION)
            #define KEYWORD_PERMUTATION_9
        #elif defined(_GSAA) && defined(_MASKMAP) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_10
        #elif defined(_GSAA) && defined(_MASKMAP)
            #define KEYWORD_PERMUTATION_11
        #elif defined(_GSAA) && defined(_EMISSION) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_12
        #elif defined(_GSAA) && defined(_EMISSION)
            #define KEYWORD_PERMUTATION_13
        #elif defined(_GSAA) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_14
        #elif defined(_GSAA)
            #define KEYWORD_PERMUTATION_15
        #elif defined(_BUMPMAP) && defined(_MASKMAP) && defined(_EMISSION) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_16
        #elif defined(_BUMPMAP) && defined(_MASKMAP) && defined(_EMISSION)
            #define KEYWORD_PERMUTATION_17
        #elif defined(_BUMPMAP) && defined(_MASKMAP) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_18
        #elif defined(_BUMPMAP) && defined(_MASKMAP)
            #define KEYWORD_PERMUTATION_19
        #elif defined(_BUMPMAP) && defined(_EMISSION) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_20
        #elif defined(_BUMPMAP) && defined(_EMISSION)
            #define KEYWORD_PERMUTATION_21
        #elif defined(_BUMPMAP) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_22
        #elif defined(_BUMPMAP)
            #define KEYWORD_PERMUTATION_23
        #elif defined(_MASKMAP) && defined(_EMISSION) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_24
        #elif defined(_MASKMAP) && defined(_EMISSION)
            #define KEYWORD_PERMUTATION_25
        #elif defined(_MASKMAP) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_26
        #elif defined(_MASKMAP)
            #define KEYWORD_PERMUTATION_27
        #elif defined(_EMISSION) && defined(FORCE_SPECCUBE_BOX_PROJECTION)
            #define KEYWORD_PERMUTATION_28
        #elif defined(_EMISSION)
            #define KEYWORD_PERMUTATION_29
        #elif defined(FORCE_SPECCUBE_BOX_PROJECTION)
