...
[Toggle(BAKERY_SH)] _BAKERY_SH("Bakery SH", Int) = 0
[Toggle(BAKERY_MONOSH)] _BAKERY_MONOSH("Bakery Mono SH", Int) = 0
...
[Toggle(_BICUBICLIGHTMAP)]_BicubicLightmap("Bicubic Lightmap", Int) = 0
